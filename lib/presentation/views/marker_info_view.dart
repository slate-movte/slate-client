    ...
    switch (widget.item.runtimeType) {
      ...
      case AttractionModel:
        ...
        travelModel = TravelModel(
            ...
            overview: attractionItem.overview,
            homepage: attractionItem.homepage,
            openTime: attractionItem.restDate);
        infoTitle = '관광정보';
        break;
      case AccommodationModel:
        ...
        travelModel = TravelModel(
            ...
            overview: accommodationItem.overview,
            homepage: accommodationItem.homepage);
        infoTitle = '숙박정보';
        break;
      case RestaurantModel:
        ...
        travelModel = TravelModel(
            ...
            openTime: restaurantItem.openTime,
            overview: restaurantItem.overview,
            homepage: restaurantItem.homepage);
        infoTitle = '식당정보';
        break;
      case TravelModel:
        travelModel = widget.item as TravelModel;
        break;
    }
          ...
          SizedBox(
            ...
            child: GoogleMap(
              ...
              initialCameraPosition:
                  CameraPosition(target: travelModel.location, zoom: 18),
              ...
              sections: [
                ItemSection(
                  ...
                  builder: ItemSectionBuilder()
                    ...
                    ..phone = travelModel.tel == null || travelModel.tel == ""
                        ? null
                        : ItemTableRow(
                            title: '전화번호',
                    ...
                    ..hours = travelModel.openTime == null ||
                            travelModel.openTime == ""
                        ? null
                        : ItemTableRow(
                            title: '영업시간',
                            body: travelModel.openTime!,
                          )
                    ..info = travelModel.overview == null ||
                            travelModel.overview == ""
                        ? null
                        : ItemTableRow(
                            title: infoTitle,
                            body: travelModel.overview!,
                          )
                    ..homePage = travelModel.homepage == null ||
                            travelModel.homepage == ""
                        ? null
                        : ItemTableRow(
                            title: '홈페이지',
